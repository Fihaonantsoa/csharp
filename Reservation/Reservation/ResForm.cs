...
namespace Reservation
{
    public class ResForm : Form
    {
        ...
        {
            dgRes.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10, FontStyle.Bold);
            dgRes.ColumnHeadersHeight = 50;
            dgRes.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(248, 248, 248);
            dgRes.RowTemplate.Height = 40;
        }
        ...
        private Boolean VerifierChamps()
        {
            ...
            if (string.IsNullOrEmpty(idtxt.Text.Trim())
                || string.IsNullOrEmpty(prix.Text.Trim()) 
                || string.IsNullOrEmpty(mode.Text.Trim()))
            {
        ...
        {
            dgRes.DataSource = service.ObtenirTous();
            FormatDataGrid();
        }
